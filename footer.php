        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 mb-md-0 mb-4">
                    <img class="pr-3  mb-md-5 mb-3" src="<?php echo get_template_directory_uri(); ?>/assets/img/logo-color.png"
                        srcset="<?php echo get_template_directory_uri(); ?>/assets/img/logo-color@2x.png 2x" alt="">
